...
class CPP.Views.DepartmentAdministrator.Readonlyregister extends CPP.Views.Base
  el: "#app"
  ...
  submit: (e) ->
    if @form.validate() == null
      data = {}
      data['readonly_administrator'] = @form.getValue()
      data['readonly_administrator[department_id]'] = @dept.id
      $.ajax
        url: "/readonly_administrators.json"
        data: data
        type: 'POST'
        success: (data) =>
